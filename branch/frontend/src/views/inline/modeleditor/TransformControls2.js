...
class TransformControls extends Object3D {
  constructor(camera, domElement) {
    ...
    this.domElement.addEventListener("mousehover", this._onPointerHover);
  ...
  dispose() {
    ...
    this.domElement.removeEventListener("mousehover", this._onPointerHover);
